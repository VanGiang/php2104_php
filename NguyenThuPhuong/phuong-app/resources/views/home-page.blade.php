...
<section id="home-section" class="hero">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(vegefoods/images/category-1.jpg);">
                            ...
                            <div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(vegefoods/images/category-2.jpg);">
                                <div class="text px-3 py-1">
                                    <h2 class="mb-0">
                                        <a href="#">Vegetables</a>
                                    </h2>
                ...
                <div class="col-md-4">
                    <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(vegefoods/images/category-3.jpg);">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0">
                                <a href="#">Juices</a>
                            </h2>
                    ...
                    <div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(vegefoods/images/category-4.jpg);">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0">
                                <a href="#">Dried</a>
                            </h2>
    ...
    <section class="ftco-section">
        ...
        <div style="margin: 0 850px;">{{ $products->links('vendor.pagination.simple-default') }}</div>
    </section>
