<x-my-app-layout>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="/themes/vegefoods/index.html">Vegefoods</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
          <span class="oi oi-menu"></span> Menu </button>
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a href="/themes/vegefoods/index.html" class="nav-link">Home</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="/themes/vegefoods/shop.html">Shop</a>
                <a class="dropdown-item" href="/themes/vegefoods/wishlist.html">Wishlist</a>
                <a class="dropdown-item" href="/themes/vegefoods/product-single.html">Single Product</a>
                <a class="dropdown-item" href="/themes/vegefoods/cart.html">Cart</a>
                <a class="dropdown-item" href="/themes/vegefoods/checkout.html">Checkout</a>
              </div>
            </li>
            <li class="nav-item">
              <a href="/themes/vegefoods/about.html" class="nav-link">About</a>
            </li>
            <li class="nav-item">
              <a href="/themes/vegefoods/blog.html" class="nav-link">Blog</a>
            </li>
            <li class="nav-item">
    ...
    <x-slot name="section">
        ...
        <div class="home-slider owl-carousel">
            <div class="slider-item" style="background-image: url(/themes/vegefoods/images/bg_1.jpg);">
            ...
            <div class="slider-item" style="background-image: url(/themes/vegefoods/images/bg_2.jpg);">
            <div class="overlay"></div>
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
        ...
        <div class="container">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                ...
                <a href="{{ route('product.show', ['id' => $product->id]) }}" class="img-prod">
                    <img class="img-fluid" src="{{ $product->image }}" alt="{{ $product->discreption }}">
                    @if ($product->sale_off > 0)
                    <span class="status">{{$product->quality}}%</span>  
                    @else                  
                    <div class="overlay"></div>
                    @endif
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                    ...
                    <div class="pricing">
                        <p class="price">
                        @if ($product->sale_off > 0)
                        <span class="mr-2 price-dc">${{$product->price}}.00</span>
                        <span class="price-sale">${{$product->price}}.00</span>
                        @else 
            ...
            <!-- <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                <a href="#" class="img-prod">
                    <img class="img-fluid" src="/themes/vegefoods/images/product-3.jpg" alt="Colorlib Template">
                    <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                    <h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                <a href="#" class="img-prod">
                    <img class="img-fluid" src="/themes/vegefoods/images/product-4.jpg" alt="Colorlib Template">
                    <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                    <h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                <a href="#" class="img-prod">
                    <img class="img-fluid" src="/themes/vegefoods/images/product-5.jpg" alt="Colorlib Template">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                <a href="#" class="img-prod">
                    <img class="img-fluid" src="/themes/vegefoods/images/product-6.jpg" alt="Colorlib Template">
                    <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                    <h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                <a href="#" class="img-prod">
                    <img class="img-fluid" src="/themes/vegefoods/images/product-7.jpg" alt="Colorlib Template">
                    <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                    <h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                <a href="#" class="img-prod">
                    <img class="img-fluid" src="/themes/vegefoods/images/product-8.jpg" alt="Colorlib Template">
                    <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                    <h3>
