			...
			<div class="container-fluid">
					<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="logo-pro">
											<a href="/themes/Admin/nalika/index.html"><img class="main-logo" src="themes/Admin/nalika/img/logo/logo.png" alt="" /></a>
									</div>
							</div>
					</div>
			</div>
												...
												<a href=""><i class="fa fa-search"></i></a>
																									...
																									<div role="menu" class="author-message-top dropdown-menu animated zoomIn">
																											...
																											<ul class="message-menu">
																													<li>
																															<a href="#">
																																	<div class="message-img">
																																			<img src="themes/Admin/nalika/img/contact/1.jpg" alt="">
																																	</div>
																													...
																													<li>
																															<a href="#">
																																	<div class="message-img">
																																			<img src="themes/Admin/nalika/img/contact/4.jpg" alt="">
																																	</div>
																																	<div class="message-content">
																																			<span class="message-date">16 Sept</span>
																																			<h2>Sulaiman din</h2>
																													...
																													<li>
																															<a href="#">
																																	<div class="message-img">
																																			<img src="themes/Admin/nalika/img/contact/3.jpg" alt="">
																																	</div>
																																	<div class="message-content">
																																			<span class="message-date">16 Sept</span>
																																			<h2>Victor Jara</h2>
																													...
																													<li>
																															<a href="#">
																																	<div class="message-img">
																																			<img src="themes/Admin/nalika/img/contact/2.jpg" alt="">
																																	</div>
																																	<div class="message-content">
																																			<span class="message-date">16 Sept</span>
																																			<h2>Victor Jara</h2>
														...
														<i class="icon nalika-down-arrow nalika-angle-dw"></i>
																									...
																									<ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
																											<li><a href="/themes/Admin/nalika/register.html"><span class="icon nalika-home author-log-ic"></span> Register</a>
																											</li>
																											<li><a href="#"><span class="icon nalika-user author-log-ic"></span> My Profile</a>
																											</li>
																											<li><a href="/themes/Admin/nalika/lock.html"><span class="icon nalika-diamond author-log-ic"></span> Lock</a>
																											</li>
																											<li><a href="#"><span class="icon nalika-settings author-log-ic"></span> Settings</a>
																											</li>
																											<li><a href="/themes/Admin/nalika/login.html"><span class="icon nalika-unlocked author-log-ic"></span> Log Out</a>
																											</li>
																									</ul>
																							</li>
																	...
																	<ul class="mobile-menu-nav">
																			<li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/index.html">Dashboard v.1</a></li>
																							<li><a href="/themes/Admin/nalika/index-1.html">Dashboard v.2</a></li>
																							<li><a href="/themes/Admin/nalika/index-3.html">Dashboard v.3</a></li>
																							<li><a href="/themes/Admin/nalika/product-list.html">Product List</a></li>
																							<li><a href="/themes/Admin/nalika/product-edit.html">Product Edit</a></li>
																							<li><a href="/themes/Admin/nalika/product-detail.html">Product Detail</a></li>
																							<li><a href="/themes/Admin/nalika/product-cart.html">Product Cart</a></li>
																							<li><a href="/themes/Admin/nalika/product-payment.html">Product Payment</a></li>
																							<li><a href="/themes/Admin/nalika/analytics.html">Analytics</a></li>
																							<li><a href="/themes/Admin/nalika/widgets.html">Widgets</a></li>
																					</ul>
																			</li>
																			<li><a data-toggle="collapse" data-target="#demo" href="#">Mailbox <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul id="demo" class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/mailbox.html">Inbox</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/mailbox-view.html">View Mail</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/mailbox-compose.html">Compose Mail</a>
																							</li>
																					</ul>
																			</li>
																			<li><a data-toggle="collapse" data-target="#others" href="#">Miscellaneous <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul id="others" class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/file-manager.html">File Manager</a></li>
																							<li><a href="/themes/Admin/nalika/contacts.html">Contacts Client</a></li>
																							<li><a href="/themes/Admin/nalika/projects.html">Project</a></li>
																							<li><a href="/themes/Admin/nalika/project-details.html">Project Details</a></li>
																							<li><a href="/themes/Admin/nalika/blog.html">Blog</a></li>
																							<li><a href="/themes/Admin/nalika/blog-details.html">Blog Details</a></li>
																							<li><a href="/themes/Admin/nalika/404.html">404 Page</a></li>
																							<li><a href="/themes/Admin/nalika/500.html">500 Page</a></li>
																					</ul>
																			</li>
																			<li><a data-toggle="collapse" data-target="#Miscellaneousmob" href="#">Interface <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul id="Miscellaneousmob" class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/google-map.html">Google Map</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/data-maps.html">Data Maps</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/pdf-viewer.html">Pdf Viewer</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/x-editable.html">X-Editable</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/code-editor.html">Code Editor</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/tree-view.html">Tree View</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/preloader.html">Preloader</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/images-cropper.html">Images Cropper</a>
																							</li>
																					</ul>
																			</li>
																			<li><a data-toggle="collapse" data-target="#Chartsmob" href="#">Charts <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul id="Chartsmob" class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/bar-charts.html">Bar Charts</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/line-charts.html">Line Charts</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/area-charts.html">Area Charts</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/rounded-chart.html">Rounded Charts</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/c3.html">C3 Charts</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/sparkline.html">Sparkline Charts</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/peity.html">Peity Charts</a>
																							</li>
																					</ul>
																			</li>
																			<li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Tables <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul id="Tablesmob" class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/static-table.html">Static Table</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/data-table.html">Data Table</a>
																							</li>
																					</ul>
																			</li>
																			<li><a data-toggle="collapse" data-target="#formsmob" href="#">Forms <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul id="formsmob" class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/basic-form-element.html">Basic Form Elements</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/advance-form-element.html">Advanced Form Elements</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/password-meter.html">Password Meter</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/multi-upload.html">Multi Upload</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/tinymc.html">Text Editor</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/dual-list-box.html">Dual List Box</a>
																							</li>
																					</ul>
																			</li>
																			...
																			<li><a data-toggle="collapse" data-target="#Pagemob" href="#">Pages <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul id="Pagemob" class="collapse dropdown-header-top">
																							<li><a href="/themes/Admin/nalika/login.html">Login</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/register.html">Register</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/lock.html">Lock</a>
																							</li>
																							<li><a href="/themes/Admin/nalika/password-recovery.html">Password Recovery</a>
																							</li>
																					</ul>
																			</li>
																	</ul>
							...
							<div class="row">
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
											<div class="single-new-trend mg-t-30">
													<a href="#"><img src="themes/Admin/nalika/img/new-product/5.png" alt=""></a>
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="personal-info-wrap">
													<div class="widget-head-info-box">
															...
															<img src="themes/Admin/nalika/img/notification/5.jpg" class="img-circle circle-border m-b-md" alt="profile">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="author-widgets-single res-mg-t-30">
													<div class="author-wiget-inner">
															<div class="perso-img">
																	<img src="themes/Admin/nalika/img/notification/6.jpg" class="img-circle circle-border m-b-md" alt="profile">
															</div>
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="personal-info-wrap personal-info-ano res-mg-t-30">
													<div class="widget-head-info-box">
															...
															<img src="themes/Admin/nalika/img/contact/2.jpg" class="img-circle circle-border m-b-md" alt="profile">
															<div class="social-widget-result">
																	<span>100 Tweets</span> |
																	<span>350 Following</span> |
																	<span>610 Followers</span>
