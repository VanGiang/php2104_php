            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="logo-pro">
                            <a href="index.html"><img class="main-logo" src="/themes/Admin/nalika/img/logo/logo.png" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <table>
																	...
																	@foreach ($products as $product)
																		<tr>
																			...
																			<td>
																				<a href="{{ route('admin.products.show', ['products' => $product->id]) }}"></a>{{ $product->name }}
																			</td>
																			<td>
																			...
																			<td><a href="{{ route('products.product-detail', ['id' => $product->id]) }}" class="pd-setting">demo</a></td>
																		</tr>
																	@endforeach
                                </table>
