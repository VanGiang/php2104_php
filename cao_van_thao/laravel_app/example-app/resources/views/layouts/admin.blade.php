...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('adminproducts.index') }}" class="brand-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('adminproducts.index') }}" 
                  class="nav-link @if (url()->current() == route('adminproducts.index'))
                    active
                  @endif ">
              ...
              <li class="nav-item">
                <a href="{{ route('adminproducts.create') }}" 
                  class="nav-link @if (url()->current() == route('adminproducts.create'))
                  active
                @endif ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>create</p>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admincategories.index') }}" class="nav-link 
              @if (url()->current() == route('admincategories.index'))
                active
              @endif ">
              <i class="nav-icon fas fa-book"></i>
              <p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admincategories.index') }}" 
                  class="nav-link @if (url()->current() == route('admincategories.index'))
                    active
                  @endif ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List</p>
              ...
              <li class="nav-item">
                <a href="{{ route('admincategories.create') }}" 
                  class="nav-link @if (url()->current() == route('admincategories.create'))
                  active
                @endif ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>create</p>
